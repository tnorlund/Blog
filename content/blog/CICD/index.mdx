...
[Hashicorp](https://www.hashicorp.com), the company that produces Terraform, offers Consul, a service for dynamically networking services.

<Consul />

Consul, along with Terraform Cloud, allows me to connect the S3 bucket hosting the static site with a Terraform deployment through a simple registry. This allows me to have many instances of the website: development, testing, staging, etc.
...
With all of this tied together, planning is as easy as making a pull request from GitHub. Each change requested can be accepted and sent through all of the previous steps. 