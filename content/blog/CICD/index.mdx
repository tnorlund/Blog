...
Consul allows me to connect the Gatsby repository with the Terraform repository through a simple registry. This registry can change the services the website uses dynamically and securely.
