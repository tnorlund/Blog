...
$$
\begin{aligned}
\mathbf{B}(t)\,=\,&\mathbf{P} _{0}+t(\mathbf {P} _{1}-\mathbf {P} _{0})\\\,=\,&(1-t)\mathbf {P} _{0}+t\mathbf {P} _{1}
\end{aligned}
$$
...
$$
\begin{aligned}
\mathbf {B} (t)\,=\,&(1-t)[(1-t)\mathbf {P} _{0}t\mathbf {P} _{1}]\\+\,&t[(1-t)\mathbf {P} _{1}+t\mathbf {P} _{2}]
\end{aligned}
$$
...
$$
\begin{aligned}
\mathbf {B} (t)=&(1-t)^{2}\mathbf {P} _{0}\\+&2(1-t)t\mathbf {P} _{1}\\+&t^{2}\mathbf {P} _{2}.
\end{aligned}
$$
...
$$
\mathbf {B} (t)=(1-t)\mathbf {B} _{\mathbf {P} _{0},\mathbf {P} _{1},\mathbf {P} _{2}}(t)+t\mathbf {B} _{\mathbf {P} _{1},\mathbf {P} _{2},\mathbf {P} _{3}}(t).
$$
