...
Now, this is a bummer, but it forced me to take a step back and understand what everything is doing. I'd like to think of this as the building blocks of the modern web. How do all these tools reduce a complex project into *only* HTML, CSS, and JavaScript?
...
We are closely approaching a time where everything will be interpreted as plain ES6 JavaScript. WebAssembly, WASM for short, enables high-performance applications in the web by converting other efficient binaries into something the browser can interpret.

<WASM />

Again, this is 2021. The most efficient way to program is not always what runs the fastest on your computer. 

<Rust />

Rust is a great programming language that is similar to C++ while guaranteeing memory safety. Rust has strict rules at compilation time that forces you to write efficient code that does not require garbage collection. I'm learning Rust now, but I plan on implementing it soon.
