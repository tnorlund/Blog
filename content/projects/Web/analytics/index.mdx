...
With the DynamoDB table designed, the functions used to process the raw data into processed data remains. I ended up following this flow diagram in the Lambda function that runs whenever Kinesis Firehose stores a '.parquet' file in the S3 bucket. 

<MdxIcon filename={`AnalyticsFlow.svg`}/>

# Conclusion

This was fun, and reduced the costs over 90%.