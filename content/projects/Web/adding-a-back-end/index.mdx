...
This was a lot of work, and I know that I had the option to use [Disqus](https://disqus.com), but this was a great introduction for me. I was able to pick up a large portion of the services AWS has to offer while also learning how to optimize and construct DynamoDB tables.