          ...
          <animated.path
            style={ {
              ...
              transform: props.x
                ...
                .interpolate( x => `scale(${x}, ${x}) rotate(-${ 180 - ( x * 180 ) }deg)` )
            } }
            name="BottomLeftCircle"
            fill={green}
            className="Circle"
            d="M26.82,78.25a14.21,14.21,0,1,1,7.1-26.5l-4.27,7.38a5.57,5.57,0,0,0-2.83-.77,5.69,5.69,0,1,0,5.68,5.69H41A14.22,14.22,0,0,1,26.82,78.25Z"
          />
          <animated.path
            style={ {
              position: `absolute`,
            ...
            fill={red}
            className="Circle"
            d="M36,48.25a14.22,14.22,0,1,1,14.2,0L46,40.87A5.68,5.68,0,0,0,46,31a5.69,5.69,0,0,0-5.69,9.85Z"
          />
          <animated.path
            style={ {
              position: `absolute`,
            ...
            name="BottomRightCircle"
            fill={blue}
            className="Circle"
            d="M59.62,78.25a14.19,14.19,0,0,1-7.07-26.5l4.25,7.38a5.58,5.58,0,0,0-2.08,2.07,5.69,5.69,0,1,0,7.77-2.08l4.26-7.38a14.21,14.21,0,0,1-7.13,26.51Z"
          />
          <animated.g
            fill={fill}
            style={ {
