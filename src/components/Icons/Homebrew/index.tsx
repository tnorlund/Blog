        ...
        <svg width="100%" height="100%" viewBox="0 0 200 100" preserveAspectRatio="XmaxYMax">
          <a.g
            ...
            style={ {
              ...
              transform: props.x
                .to( [min_x, steps[0].start, steps[0].stop, steps[1].start, steps[1].stop, max_x], [1, 1, 0, 0, -1, 0] )
                .to( x => ( x < 0 ) ? `rotate(${ -x * 15 }deg)` : `translate3d(-${ x * 100 }%, 0, 0)` )
            } }
          >
            <path
              name="glass"
          ...
          >
            <path d="M70.92,58.73V52.19H65v6.54H60V41.82h5v6.42h6V41.82h5V58.73Z"/>
            <path d="M77.64,52.13c0-4.32,2.7-6.9,6.91-6.9s6.9,2.56,6.9,6.9-2.61,6.93-6.9,6.93S77.64,56.57,77.64,52.13Zm8.93,0c0-2.18-.78-3.46-2-3.46s-2,1.28-2,3.46.76,3.47,2,3.47S86.57,54.38,86.57,52.14Z"/>
            <path d="M93,45.56h4.69v2.65h.09a3.86,3.86,0,0,1,3.77-2.91,3.37,3.37,0,0,1,3.66,2.88h.1a4,4,0,0,1,4-2.88,4.22,4.22,0,0,1,4.34,4.52v8.91h-4.81V51.07c0-1.27-.55-1.91-1.64-1.91s-1.62.72-1.62,1.91v7.66H101V51.07c0-1.26-.57-1.91-1.63-1.91s-1.63.73-1.63,1.91v7.66H93Z"/>
            <path d="M128.46,54.48c-.41,2.82-2.89,4.58-6.47,4.58-4.3,0-6.87-2.57-6.87-6.85s2.59-7,6.72-7,6.68,2.6,6.68,6.63v1.3h-8.76v.31a2.2,2.2,0,0,0,2.3,2.28,2.12,2.12,0,0,0,2.11-1.27Zm-8.63-3.93H124a2,2,0,0,0-2.1-2A2.08,2.08,0,0,0,119.83,50.55Z"/>
            <path d="M135,56.46h-.1v2.27h-4.8V40.94h4.8v7h.1a4,4,0,0,1,3.92-2.56c3.33,0,5.18,2.43,5.18,6.77s-1.84,6.78-5.12,6.78A4,4,0,0,1,135,56.46Zm-.12-4.3c0,1.88.83,3,2.16,3s2.14-1.18,2.14-3.06-.84-3-2.14-3S134.89,50.28,134.88,52.16Z"/>
            <path d="M145.62,45.56h4.69v2.58h.1c.49-1.87,1.51-2.77,3.08-2.77a3.18,3.18,0,0,1,1.13.19v4a3.77,3.77,0,0,0-1.41-.27,2.48,2.48,0,0,0-2.78,2.79v6.61h-4.81Z"/>
            <path d="M168.55,54.48c-.41,2.82-2.89,4.58-6.47,4.58-4.3,0-6.87-2.57-6.87-6.85s2.59-7,6.72-7,6.68,2.6,6.68,6.63v1.3h-8.76v.31a2.2,2.2,0,0,0,2.3,2.28,2.13,2.13,0,0,0,2.11-1.27Zm-8.63-3.93h4.2a2,2,0,0,0-2.1-2A2.08,2.08,0,0,0,159.92,50.55Z"/>
            <path d="M186.68,58.73h-5.22l-1.86-8.54h-.1l-1.84,8.54h-5.12l-3.35-13.17h4.86l1.43,8.95h.1l1.77-8.95h4.58l1.8,8.95h.1l1.43-8.95H190Z"/>
          </a.g>
        </svg>
      ) }
    </Spring>
