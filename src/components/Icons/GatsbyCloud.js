    ...
    <Spring native to={{ x: inView ?  max_x : min_x }}>
      { ( props ) => (
        <svg width="100%" height="100%" viewBox="0 0 200 100" preserveAspectRatio="YMax">
          <defs>
            {/* <style>.cls-1{fill:none;}.cls-2{clip-path:url(#clip-path);}.cls-3{fill:#4696d2;}.cls-4{fill:#fff;}.cls-5{fill-rule:evenodd;fill:url(#linear-gradient);}.cls-6{fill:#4595d1;}.cls-7{fill:#663795;}.cls-8{fill:#231f20;}</style> */}
            ...
            <linearGradient id="gatsby-linear-gradient" x1="58.14" y1="-171.02" x2="35.4" y2="-171.02" gradientTransform="matrix(1, 0, 0, -1, 0, -124.09)" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#663795"/>
              <stop offset="1" stopColor="#4595d1"/>
            </linearGradient>
          </defs>
          <g
          ...
          >
            ...
            >
              ...
              <circle fill={`var(--color-background)`} className="cls-4" cx="28.21" cy="51.83" r="6.79"/>
              <circle fill={`var(--color-background)`} className="cls-4" cx="45.38" cy="46.88" r="12.11"/>
              <rect fill={`var(--color-background)`} className="cls-4" x="28.21" y="51.87" width="18.46" height="6.75"/>
              <circle fill={`var(--color-background)`} className="cls-4" cx="32.83" cy="46.16" r="2.23"/>
            ...
            <animated.circle
              ...
              fill={`#663795`} cx="53.67" cy="57.71" r="13.5"
            />
            <animated.g
              style={ {
                opacity: props.x
