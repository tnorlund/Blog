    ...
    <Spring native to={{ x: inView ?  max_x : min_x }}>
      { ( props ) => (
        <svg width="100%" height="100%" viewBox="0 0 200 100" preserveAspectRatio="YMax">
          <animated.polygon
            style={ {
              // transformOrigin: `21.6696% 55.4349%`,
              transform: props.x
                .interpolate( { range: [min_x, steps[1].start, steps[1].stop, max_x], output: [1, 1, 0, 0] } )
                .interpolate( x => `translate3d(${ x * 100 }%,${ x * 100 * 0.980713704005331 }%, 0)` )
            } }
            fill={blue}
            className="cls-1"
            points="29.32 64.41 33.52 68.64 57.36 44.33 53.55 42.23 29.32 64.41"
          />
          <animated.polygon
            style={ {
              transform: props.x
                .interpolate( { range: [min_x, steps[2].start, steps[2].stop, max_x], output: [1, 1, 0, 0] } )
                .interpolate( x => `translate3d(${ x * 100 * -1.0196655720379 }%,${ x * 100 }%, 0)` )
            } }
            fill={blue}
            className="cls-1"
            points="24.28 59.29 27.9 62.98 41.62 50.92 37.98 48.27 24.28 59.29"
          />
          <animated.polygon
            style={ {
              transform: props.x
            ...
            fill={blue}
            className="cls-1"
            points="39.07 47.38 42.71 49.95 52.24 41.53 48.77 39.62 39.07 47.38"
          />

          <animated.polygon
            style={ {
              transform: props.x
                .interpolate( { range: [min_x, steps[3].start, steps[3].stop, max_x], output: [1, 1, 0, 0] } )
                .interpolate( x => `translate3d(${ x * 100 * -1.0196655720379 }%,${ x * 100 }%, 0)` )
            } }
            fill={blue}
            className="cls-1"
            points="19.9 54.83 23.09 58.06 29.86 52.81 26.65 50.06 19.9 54.83"
          />
          <animated.polygon
            style={ {
              transform: props.x
                .interpolate( { range: [min_x, steps[3].start, steps[3].stop, max_x], output: [1, 1, 0, 0] } )
                .interpolate( x => `translate3d(${ x * 100 * 0.915064095952073 }%,${ x * -100 }%, 0)` )
            } }
            fill={blue}
            className="cls-1"
            points="31.14 51.8 47.55 39 44.39 37.27 27.93 49.07 31.14 51.8"
          />
          <animated.polygon
            style={ {
              transform: props.x
            ...
            fill={blue}
            className="cls-1"
            points="16.06 50.91 18.85 53.77 38.24 40.23 35.33 38.35 16.06 50.91"
          />
          <animated.polygon
            style={ {
              transform: props.x
            ...
            fill={blue}
            className="cls-1"
            points="36.37 37.76 39.2 39.53 43.34 36.7 40.47 35.08 36.37 37.76"
          />
          <animated.polygon
            style={ {
              transform: props.x
              // .interpolate( { range: [min_x, max_x], output: [0, 1] } )
                .interpolate( { range: [min_x, steps[5].start, steps[5].stop, max_x], output: [1, 1, 0, 0] } )
                .interpolate( x => `translate3d(${ x * 100 * -1.0196655720379 }%,${ x * 100 }%, 0)` )
            } }
            fill={blue}
            class="cls-1"
            points="12.65 47.42 15.15 49.93 28.48 41.54 25.91 39.58 12.65 47.42"
          />
          <animated.polygon
            style={ {
              transform: props.x
            ...
            fill={blue}
            class="cls-1"
            points="26.98 38.95 29.62 40.79 39.42 34.59 36.86 33.15 26.98 38.95"
          />
          <animated.polygon
            style={ {
              transform: props.x
                .interpolate( { range: [min_x, steps[6].start, steps[6].stop, max_x], output: [1, 1, 0, 0] } )
                .interpolate( x => `translate3d(${ x * -100 }%,${ x * 100 * -0.980713704005331 }%, 0)` )
            } }
            fill={blue}
            className="cls-1"
            points="9.59 44.26 11.79 46.56 35.92 32.67 33.52 31.36 9.59 44.26"
          />
          <animated.g
            style={ {
              opacity: props.x
