      ...
      { ( props ) => (
        <svg width="100%" height="100%" viewBox="0 0 200 100" preserveAspectRatio="XmaxYMax">
          ...
          <a.circle
            ...
            fill={purple} className="cls-1" cx="32.36" cy="50" r="24.18"
          />
          <a.path
            style={ { opacity: props.x.to( [min_x, steps[1].start, steps[1].stop, max_x], [0, 0, 1, 1] ).to( x => x ) } }
            fill={`white`} d="M51.36,50H39.27v3.46h8.29a15.67,15.67,0,0,1-10,11.23L17.67,44.82A15.55,15.55,0,0,1,32.36,34.46,16,16,0,0,1,45.14,41l2.59-2.25a19,19,0,0,0-33.86,7.09l22.8,22.8A19.43,19.43,0,0,0,51.36,50Z"
          />
          <a.path
            style={ { opacity: props.x.to( [min_x, steps[1].start, steps[1].stop, max_x], [0, 0, 1, 1] ).to( x => x ) } }
            fill={`white`} d="M13.35,50.18A18.42,18.42,0,0,0,18.88,63.3,18.76,18.76,0,0,0,32,68.83Z"
          />
        </svg>
      ) }
    </Spring>
