      ...
      { ( props ) => (
        <svg width="100%" height="100%" viewBox="0 0 200 100" preserveAspectRatio="YMax">
          ...
          <animated.g
            style={ {
              opacity: props.x
                .interpolate( { range: [min_x, steps[4].start, steps[4].stop, max_x], output: [0, 0, 0.1, 0.1] } )
                .interpolate( x => x ),
            } }
            fill={grey} id="Shadows"
          >
            <path className="cls-3" d="M59.65,26,78.29,36.55l.2,7.34-12.38-6L66,43.08l6.66,3.13L72.91,54l-6.46-2.45L66.93,64l-7.21-3.88Z"/>
            <path className="cls-3" d="M10.75,39.23l24-13.71.52,7-7.51,4.37.39,27-6.46,3.39L20.61,41.26,11.4,46.55l-.59-7.06Z"/>
          </animated.g>
          <animated.g
            style={ {
              opacity: props.x
          ...
          <animated.g
            style={ {
              ...
              transform: props.x
                ...
                .interpolate( x => `translate3d(${x * 56.6374186243985}%,${x * 100}%, 0)` )
            } }
            id="Right"
          >
            <polygon fill={light} className="cls-4" points="42.17 39.62 57.29 48.33 62.4 45.37 47.23 36.74 42.17 39.62"/>
            <polygon fill={mid} className="cls-5" points="57.29 48.33 57.36 54.12 62.45 51.16 62.4 45.37 57.29 48.33"/>
            <polygon fill={dark} className="cls-6" points="57.36 54.12 42.17 45.43 42.17 39.62 57.29 48.33 57.36 54.12"/>
          </animated.g>
          <animated.g
            style={ {
              ...
              transform: props.x
                ...
                .interpolate( x => `translate3d(0,${x * 100}%, 0)` )
            } }
            id="Middle"
          >
            <polygon fill={light} className="cls-4" points="42.09 45.47 47.25 42.52 42.19 39.61 37.06 42.54 42.09 45.47"/>
            <polygon fill={mid} className="cls-5" points="42.09 45.47 42.16 74.48 47.25 71.52 47.25 42.52 42.09 45.47"/>
            <polygon fill={dark} className="cls-6" points="37.06 71.42 42.16 74.48 42.09 45.47 37.06 42.54 37.06 71.42"/>
          </animated.g>
          <animated.g
            style={ {
              transformOrigin: `26.154% 45.43%`,
          ...
          <animated.g
            ...
            id="Left"
          >
            <polygon fill={light} className="cls-4" points="37.11 42.51 42.16 45.43 31.96 51.21 26.87 48.32 37.11 42.51"/>
            <polygon fill={dark} className="cls-6" points="26.87 48.32 31.96 51.21 31.96 56.99 26.87 53.98 26.87 48.32"/>
            <polygon fill={mid} className="cls-5" points="42.16 45.43 42.19 51.28 31.96 56.99 31.96 51.21 42.16 45.43"/>
          </animated.g>
