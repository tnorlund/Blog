      ...
      { ( props ) => (
        <svg width="100%" height="100%" viewBox="0 0 200 100" preserveAspectRatio="YMax">
          <animated.path
            strokeDashoffset={
              props.x
                .interpolate( { range: [max_x, steps[1].start, steps[1].stop, min_x], output: [1, 1, 0, 0] } )
                .interpolate( x => x * 120 )
            }
            strokeDasharray={120}
            stroke={light}
          ...
          <animated.circle
            ...
            fill={light}
            className="cls-3" cx="49.78" cy="50.11" r="2.62"
          />
          <animated.circle
            style={ {
              position: `absolute`,
            ...
            fill={light}
            className="cls-3" cx="56.88" cy="45.96" r="2.62"
          />
          <animated.circle
            style={ {
              position: `absolute`,
            ...
            fill={light} className="cls-3" cx="56.77" cy="54.59" r="2.62"
          />
          <animated.circle
            style={ {
              position: `absolute`,
            ...
            fill={light} className="cls-3" cx="60.49" cy="62.62" r="2.62"
          />
          <animated.circle
            style={ {
              position: `absolute`,
