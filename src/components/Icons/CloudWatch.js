    ...
    <Spring native to={{ x: inView ?  max_x : min_x }}>
      { ( props ) => (
        <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="YMax">
          <defs>
            {/* <style>.cls-1{fill:url(#linear-gradient);}.cls-2,.cls-3{fill:none;stroke:#fff;stroke-width:1.75px;}.cls-2{stroke-linejoin:round;}.cls-3{stroke-miterlimit:10;}</style> */}
