      ...
      { ( props ) => (
        ...
        >
          ...
          <animated.circle id="C1"
            fill={fill}
            cx={
              props.x.to( t => width / 2 + a * Math.cos( t * 2 *  Math.PI ) )
            }
            cy={
              props.x.to( t => height / 2 + b * Math.sin( -t * 2 * Math.PI ) )
            }
            r={radius}
          />
          <animated.line id="C1"
          ...
          <animated.circle id="C2"
            fill={fill}
            cx={
              props.x.to( t => width / 2 + a * Math.cos( -t * 2 *  Math.PI - Math.PI / 2 ) )
            }
            cy={
              props.x.to( t => height / 2 + b * Math.sin( t * 2 * Math.PI - Math.PI / 2 ) )
            }
            r={radius}
          />
          <animated.line
